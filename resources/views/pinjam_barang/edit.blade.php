    ...
    <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border px-6 py-6">
        ...
        <form action="{{ route('pinjam_barang.update', $pinjam_barang->id) }}" method="POST">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold text-gray-900">Edit Data Pinjam Barang</h2>
                ...
                <div class="mt-5">
                    ...
                    <input id="id_pinjam" name="id_pinjam" type="number" value="{{ old('id_pinjam', $pinjam_barang->id_pinjam) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm" readonly>
                </div>

                <div class="mt-5">
                    <label for="peminjam" class="block text-sm font-medium text-gray-900">Peminjam</label>
                    <input id="peminjam" name="peminjam" type="text" value="{{ old('peminjam', $pinjam_barang->peminjam) }}" required
                ...
                <div class="mt-5">
                    ...
                    <input id="tgl_pinjam" name="tgl_pinjam" type="date" value="{{ old('tgl_pinjam', $pinjam_barang->tgl_pinjam) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
                ...
                <div class="mt-5">
                    ...
                    <input id="id_barang" name="id_barang" type="number" value="{{ old('id_barang', $pinjam_barang->id_barang) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm" readonly>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <input id="nama_barang" name="nama_barang" type="text" value="{{ old('nama_barang', $pinjam_barang->nama_barang) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>

                <div class="mt-5">
                    <label for="jml_barang" class="block text-sm font-medium text-gray-900">Jumlah Barang</label>
                    <input id="jml_barang" name="jml_barang" type="number" value="{{ old('jml_barang', $pinjam_barang->jml_barang) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>

                <div class="mt-5">
                    <label for="tgl_kembali" class="block text-sm font-medium text-gray-900">Tanggal Kembali</label>
                    <input id="tgl_kembali" name="tgl_kembali" type="date" value="{{ old('tgl_kembali', $pinjam_barang->tgl_kembali) }}" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
                ...
                <div class="mt-5">
                    ...
                    <textarea id="kondisi" name="kondisi" rows="3" required
                        class="block w-full rounded-md border-gray-300 py-1.5 px-3 text-gray-900 shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">{{ old('kondisi', $pinjam_barang->kondisi) }}</textarea>
                </div>
            </div>
